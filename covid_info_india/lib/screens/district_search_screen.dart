...
class _DistrictSearchScreenState extends State<DistrictSearchScreen> {
  ...
  getData() async {
    ...
    // vaccineMinAgeLimit =
    //     dataDistrictsSlot['centers'][0]["sessions"][0]["min_age_limit"];
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      //     labell: "Slot2",
                                      //     detailsReturned:
                                      //         "${dataDistrictsSlot['centers'][index]["sessions"][0]["slots"][1] != null ? dataDistrictsSlot['centers'][index]["sessions"][0]["slots"][1] : "null"}"),
                                    ],
                                  ),
                                ),
                              );
